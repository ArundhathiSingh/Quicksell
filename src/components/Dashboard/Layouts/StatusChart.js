      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            ...
            <div className="p4">Backlog</div>
            <div className="p4 color-gray-3">
        ...
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img
              ...
              fill="white"
            />
            <div className="p4">In progress</div>
            <div className="p4 color-gray-3">
        ...
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img
              ...
              fill="white"
            />
            <div className="p4">Cancelled</div>
            <div className="p4 color-gray-3">
