  ...
  return (
    <div className={styles.ds_chart}>
      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img src={NoPSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
            <div className="p4">No Priority</div>
            <div className="p4 color-gray-3">{state["0"] ? state["0"].length : 0}</div>
          </div>
      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img src={UrgentSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
            <div className="p4">Urgent</div>
            <div className="p4 color-gray-3">{state["1"] ? state["1"].length : 0}</div>
          </div>
          <div className={styles.r}>
            <img src={MoreSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
          </div>
      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img src={HighSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
            <div className="p4">High</div>
            <div className="p4 color-gray-3">{state["2"] ? state["2"].length : 0}</div>
          </div>
          <div className={styles.r}>
            <img src={MoreSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
          </div>
      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img src={MedSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
            <div className="p4">Medium</div>
            <div className="p4 color-gray-3">{state["3"] ? state["3"].length : 0}</div>
          </div>
          <div className={styles.r}>
            <img src={MoreSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
          </div>
      ...
      <div className={styles.chart_col}>
        <div className={styles.chart_head}>
          <div className={styles.l}>
            <img src={LowPSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
            <div className="p4">Low</div>
            <div className="p4 color-gray-3">{state["4"] ? state["4"].length : 0}</div>
          </div>
          <div className={styles.r}>
            <img src={MoreSvg} alt="" style={{ height: 15, width: 15 }} fill="white" />
          </div>
